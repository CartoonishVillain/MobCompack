...
public class FabricSpawns {
    public static void addSpawns() {
        ...
        SpawnPlacements.register(FabricRegister.CRYSTALINESLIME, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
        SpawnPlacements.register(FabricRegister.JAWBREAKER, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
    }
}
