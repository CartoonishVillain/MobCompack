...
public class NeoForgeRoseTintedMonocle extends RoseTintedMonocle {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public NeoForgeRoseTintedMonocle(ArmorMaterial materialIn, Type slot, Properties builder) {
