...
public class HammerModel extends GeoModel<Hammer> {
    ...
    public ResourceLocation getModelResource(Hammer object) {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "geo/sediment_devourer.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(Hammer object) {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/item/sediment_devourer.png");
    }
