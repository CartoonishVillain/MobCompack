...
public class JawsModel extends GeoModel<Jaws> {
    ...
    public ResourceLocation getModelResource(Jaws object) {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "geo/jawbreaker.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(Jaws object) {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/entity/jawbreaker.png");
    }

    @Override
    public ResourceLocation getAnimationResource(Jaws animatable) {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "animations/jawbreaker_animation.json");
    }
}
