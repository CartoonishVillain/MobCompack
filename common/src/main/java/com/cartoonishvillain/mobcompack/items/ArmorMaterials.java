...
public enum ArmorMaterials implements ArmorMaterial {
    GLUTTONY(Constants.MOD_ID + ":gluttony", 2048, new int[] {2, 0, 0, 1}, 8, SoundEvents.ARMOR_EQUIP_GENERIC, 0, ()->{return Ingredient.of(Services.PLATFORM.getGiantTooth());}, 0.0f),
    RMONICLE(Constants.MOD_ID + ":monicle", 33, new int[]{3, 6, 8, 3}, 8, SoundEvents.ARMOR_EQUIP_GENERIC, 0, ()->{return Ingredient.of(Items.NETHERITE_INGOT);}, 0.0f);
