...
public class ArrowOfChompingEntity extends AbstractArrow {
    ...
    public ArrowOfChompingEntity(EntityType<? extends AbstractArrow> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);
        this.setBaseDamage(this.getBaseDamage() + 1f);
    }

    public ArrowOfChompingEntity(EntityType<? extends AbstractArrow> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
        super(p_36711_, p_36712_, p_36713_, p_36714_, p_36715_);
        this.setPos(new Vec3(p_36712_, p_36713_, p_36714_));
        this.setBaseDamage(this.getBaseDamage() + 1f);
    }

    public ArrowOfChompingEntity(EntityType<? extends AbstractArrow> p_36717_, LivingEntity p_36718_, Level p_36719_) {
