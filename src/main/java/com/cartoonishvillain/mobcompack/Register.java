...
public class Register {
    ...
    public static final RegistryObject<Item> CRYSTALLINESLIMESPAWN = ITEMS.register("crystallineslime_egg", () -> new CustomSpawnEgg(Register.CRYSTALLINESLIME, 12189768, 16187515, new Item.Properties().tab(MobCompack.TAB)));
    public static final RegistryObject<Item> JAWBREAKERSPAWN = ITEMS.register("jawbreaker_egg", () -> new CustomSpawnEgg(Register.JAWS, 9774630, 16777184, new Item.Properties().tab(MobCompack.TAB)));
    ...
    public static final RegistryObject<Item> ARROW_OF_CHOMPING_ITEM = ITEMS.register("arrow_of_chomping", () -> new ChompArrowItem(new Item.Properties().tab(MobCompack.TAB)));

    public static final RegistryObject<ArmorItem> SYMBOLGLUTTONY = ITEMS.register("symbol_of_gluttony", () -> new SymbolOfGluttony(ArmorMaterials.GLUTTONY, EquipmentSlot.HEAD, new Item.Properties().tab(MobCompack.TAB)));
    public static final RegistryObject<ArmorItem> ROSETINTEDMONOCLE = ITEMS.register("rose_tinted_monocle", () -> new RoseTintedMonocle(ArmorMaterials.RMONICLE, EquipmentSlot.HEAD, new Item.Properties().tab(MobCompack.TAB)));

    public static final RegistryObject<Item> ROSEGELBALL = ITEMS.register("rose_gelball", () -> new Item(new Item.Properties().tab(MobCompack.TAB)));
    public static final RegistryObject<Item> GIANTTOOTH = ITEMS.register("giant_tooth", () -> new Item(new Item.Properties().tab(MobCompack.TAB)));
