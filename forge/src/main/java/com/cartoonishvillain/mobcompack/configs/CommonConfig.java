...
public class CommonConfig {
    ...
    public CommonConfig(ForgeConfigSpec.Builder builder, ConfigHelper.Subscriber subscriber) {
        ...
        this.CRYSTALSLIMETHORNSPERCENT = subscriber.subscribe(builder.comment("Changes the odds that Crystalline Slime Thorns will trigger").defineInRange("crystalSlimeThornChance", 35, 0, 100));
        builder.pop();
    }
